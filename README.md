...
To install the tools needed for testing and logo processing on Ubuntu, Fedora, or Windows, follow [docs/guides/SETUP.md](docs/guides/SETUP.md).
...
For auto-updates, download repository.dobbelina-1.0.6.zip here: https://rpeters1430.github.io/repository.dobbelina/repository.dobbelina/repository.dobbelina-1.0.6.zip
