    ...
    assert captured_downloads == [
        {
            ...
            'icon': 'https://cdn.tokyo-motion.net/img/first.jpg|Referer=https://www.tokyomotion.net/',
            'duration': '10:01',
            'quality': 'HD',
        },
        {
            ...
            'mode': 'tokyomotion.Playvid',
            'icon': 'https://cdn.tokyo-motion.net/img/second.jpg|Referer=https://www.tokyomotion.net/',
            'duration': '05:59',
            'quality': '',
        },
    ]
...
def test_playvid_uses_source_tag(monkeypatch):
    ...
    assert played['url'] == 'https://cdn.tokyo-motion.net/videos/abc123.m3u8|Referer=https://www.tokyomotion.net/'
