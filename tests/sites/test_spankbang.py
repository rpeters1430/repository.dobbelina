...
def test_models_alphabet(monkeypatch):
    ...
    fixture_mapped_get_html(monkeypatch, spankbang, {url: 'spankbang_models_alphabet.html'})
...
def test_tags_pagination(monkeypatch):
    ...
    assert next_page[0]['mode'] == 'spankbang.Tags'  # Important: It should call Tags recursively, not List
