...
def test_negative_listings(monkeypatch, case_name, module, func_name, func_args, func_kwargs, fixture_path, expect_notify):
    ...
    monkeypatch.setattr(module.site, "add_download_link", lambda *a, **k: captured_videos.append(a))
    monkeypatch.setattr(module.site, "add_dir", lambda *a, **k: captured_dirs.append(a))
    monkeypatch.setattr(module.utils, "notify", lambda *a, **k: notifications.append((a, k)))
