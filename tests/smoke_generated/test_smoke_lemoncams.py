"""Smoke tests for lemoncams site"""
...
def site_module():
    """Get site module"""
    return importlib.import_module("resources.lib.sites.lemoncams")
...
def _dispatch_preferred_listing(site_object, captured_items):
    ...
    for mode in URL_Dispatcher.func_registry.keys():
        if mode.startswith("lemoncams.") and 'list' in mode.lower():
            list_mode = mode
            break
...
# Note: lemoncams is a webcam/live site
