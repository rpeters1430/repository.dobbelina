...
class TestVideoListsLegacy:
    ...
    def test_videos_list_basic_parsing(self, monkeypatch):
        ...
        def mock_add_download_link(name, url, mode, img, desc='', duration='', quality='', contextm=None):
    ...
    def test_next_page_basic(self):
        ...
        try:
            ...
            if len(captured_dirs) > 0:
                assert '/page/2' in captured_dirs[0]['url'] or 'page' in captured_dirs[0]['url'].lower()
        except Exception:
...
class TestUrlNormalization:
    ...
    def test_get_vidhost_various_domains(self):
        ...
        assert utils.get_vidhost('//protocol-relative.com/file') == 'protocol-relative.com'
    ...
    def test_fix_url_protocol_relative(self):
        ...
        assert utils.fix_url('https://already-absolute.com/video.mp4') == 'https://already-absolute.com/video.mp4'
