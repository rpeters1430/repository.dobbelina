...
site_freeuseporn = importlib.import_module("resources.lib.sites.freeuseporn")

def test_freeuseporn():
    print("Testing freeuseporn...")
    site_url = "https://www.freeuseporn.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_freeuseporn.List(f"{site_url}videos?o=mr&page=1")
    ...
    html = utils.getHtml(f"{site_url}videos?o=mr&page=1")
    ...
    if item:
        ...
        try:
            site_freeuseporn.Playvid(video_url, "Test Video")
