...
site_pornroom = importlib.import_module("resources.lib.sites.pornroom")

def test_pornroom():
    print("Testing pornroom...")
    site_url = "https://thepornroom.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_pornroom.pornroom_list(f"{site_url}?filter=latest")
    ...
    if item:
        ...
        try:
            site_pornroom.pornroom_play(video_url, "Test Video")
