...
site_eroticmv = importlib.import_module("resources.lib.sites.eroticmv")

def test_eroticmv():
    print("Testing eroticmv...")
    site_url = "http://eroticmv.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_eroticmv.List(f"{site_url}category/decades/?archive_query=latest")
    ...
    print("\n--- Testing Categories ---")
    try:
        site_eroticmv.Categories(site_url)
    ...
    html = utils.getHtml(f"{site_url}category/decades/?archive_query=latest")
    ...
    if article:
        ...
        try:
            site_eroticmv.Playvid(video_url, "Test Video")
