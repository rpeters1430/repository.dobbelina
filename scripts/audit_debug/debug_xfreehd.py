...
site_xfreehd = importlib.import_module("resources.lib.sites.xfreehd")

def test_xfreehd():
    print("Testing xfreehd...")
    site_url = "https://www.xfreehd.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_xfreehd.List(f"{site_url}videos?o=mr")
    ...
    if item:
        ...
        try:
            site_xfreehd.Play(video_url, "Test Video")
