...
site_netflixporno = importlib.import_module("resources.lib.sites.netflixporno")

def test_netflixporno():
    print("Testing netflixporno...")
    site_url = "https://netflixporno.net/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_netflixporno.List(f"{site_url}adult/")
    ...
    html = utils.getHtml(f"{site_url}adult/", site_url)
    ...
    if item:
        ...
        try:
            site_netflixporno.Playvid(video_url, "Test Video")
