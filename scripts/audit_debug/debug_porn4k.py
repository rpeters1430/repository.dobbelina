...
site_porn4k = importlib.import_module("resources.lib.sites.porn4k")

def test_porn4k():
    print("Testing porn4k...")
    site_url = "https://porn4k.to/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_porn4k.List(f"{site_url}page/1/")
    ...
    html = utils.getHtml(f"{site_url}page/1/")
    ...
    if item:
        ...
        try:
            site_porn4k.Playvid(video_url, "Test Video")
