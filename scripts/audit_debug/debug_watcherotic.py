...
site_watcherotic = importlib.import_module("resources.lib.sites.watcherotic")

def test_watcherotic():
    print("Testing watcherotic...")
    site_url = "https://watcherotic.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_watcherotic.List(f"{site_url}latest-updates/")
    ...
    item = soup.select_one(".thumb.thumb_rel.item")
    if item:
        ...
        try:
            site_watcherotic.Play(video_url, "Test Video")
