...
site_freepornvideos = importlib.import_module("resources.lib.sites.freepornvideos")

def test_freepornvideos():
    print("Testing freepornvideos...")
    site_url = "https://www.freepornvideos.xxx/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_freepornvideos.List(f"{site_url}latest-updates/")
    ...
    if item:
        ...
        try:
            site_freepornvideos.Playvid(video_url, "Test Video")
