...
site_pornditt = importlib.import_module("resources.lib.sites.pornditt")

def test_pornditt():
    print("Testing pornditt...")
    site_url = "https://v.pornditt.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_pornditt.List(f"{site_url}latest-updates/")
    ...
    if item:
        ...
        try:
            site_pornditt.Playvid(video_url, "Test Video")
