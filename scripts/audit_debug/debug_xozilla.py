...
site_xozilla = importlib.import_module("resources.lib.sites.xozilla")

def test_xozilla():
    print("Testing xozilla...")
    site_url = "https://www.xozilla.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_xozilla.List(f"{site_url}latest-updates/")
    ...
    if item:
        ...
        try:
            site_xozilla.Playvid(video_url, "Test Video")
