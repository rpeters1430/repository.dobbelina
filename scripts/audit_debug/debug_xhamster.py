...
site_xhamster = importlib.import_module("resources.lib.sites.xhamster")

def test_xhamster():
    print("Testing xhamster...")
    site_url = "https://xhamster.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_xhamster.List(f"{site_url}newest")
    ...
    if item:
        ...
        try:
            site_xhamster.Playvid(video_url, "Test Video")
