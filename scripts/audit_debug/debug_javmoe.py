...
site_javmoe = importlib.import_module("resources.lib.sites.javmoe")

def test_javmoe():
    print("Testing javmoe...")
    site_url = "https://javmama.me/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_javmoe.List(site_url)
