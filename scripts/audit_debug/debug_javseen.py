...
site_javseen = importlib.import_module("resources.lib.sites.javseen")

def test_javseen():
    print("Testing javseen...")
    site_url = "https://javseen.tv/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_javseen.List(f"{site_url}recent/")
    ...
    if item:
        ...
        try:
            site_javseen.Playvid(video_url, "Test Video")
