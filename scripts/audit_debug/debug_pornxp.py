...
site_pornxp = importlib.import_module("resources.lib.sites.pornxp")

def test_pornxp():
    print("Testing pornxp...")
    site_url = "https://pornxp.com-mirror.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_pornxp.List(f"{site_url}")
    ...
    item = soup.select_one(".item_cont")
    if item:
        ...
        try:
            site_pornxp.Playvid(video_url, "Test Video")
