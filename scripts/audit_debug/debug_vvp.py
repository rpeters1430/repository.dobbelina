...
site_vvp = importlib.import_module("resources.lib.sites.viralvideosporno")

def test_vvp():
    print("Testing viralvideosporno...")
    site_url = "https://www.viralvideosporno.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_vvp.List(site_url)
    ...
    if item:
        ...
        try:
            site_vvp.Playvid(video_url, "Test Video")
