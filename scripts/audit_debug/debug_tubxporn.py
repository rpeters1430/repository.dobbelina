...
site_tubxporn = importlib.import_module("resources.lib.sites.tubxporn")

def test_tubxporn():
    print("Testing tubxporn...")
    site_url = "https://web.tubxporn.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_tubxporn.List(f"{site_url}latest-updates/")
