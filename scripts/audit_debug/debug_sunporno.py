...
site_sunporno = importlib.import_module("resources.lib.sites.sunporno")

def test_sunporno():
    print("Testing sunporno...")
    site_url = "https://www.sunporno.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_sunporno.List(f"{site_url}recent/")
    ...
    if item:
        ...
        try:
            site_sunporno.Playvid(video_url, "Test Video")
