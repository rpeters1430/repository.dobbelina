...
site_someporn = importlib.import_module("resources.lib.sites.someporn")

def test_someporn():
    print("Testing someporn...")
    site_url = "https://some.porn/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_someporn.List(f"{site_url}")
    ...
    item = soup.select_one("article.videocard")
    if item:
        ...
        try:
            site_someporn.Playvid(video_url, "Test Video")
