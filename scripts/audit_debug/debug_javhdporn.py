...
site_javhdporn = importlib.import_module("resources.lib.sites.javhdporn")

def test_javhdporn():
    print("Testing javhdporn...")
    site_url = "https://www4.javhdporn.net/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_javhdporn.List(site_url)
    ...
    if item:
        ...
        try:
            site_javhdporn.Play(video_url, "Test Video")
