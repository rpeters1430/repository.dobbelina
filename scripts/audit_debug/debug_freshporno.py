...
site_freshporno = importlib.import_module("resources.lib.sites.freshporno")

def test_freshporno():
    print("Testing freshporno...")
    site_url = "https://freshporno.org/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_freshporno.List(site_url)
    ...
    item = soup.select_one(".thumbs-inner")
    if item:
        ...
        try:
            site_freshporno.Playvid(video_url, "Test Video")
