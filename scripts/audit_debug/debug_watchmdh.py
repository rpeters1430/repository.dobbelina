...
site_watchmdh = importlib.import_module("resources.lib.sites.watchmdh")

def test_watchmdh():
    print("Testing watchmdh...")
    site_url = "https://watchdirty.is/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_watchmdh.List(f"{site_url}latest-updates/")
    ...
    if item:
        ...
        try:
            site_watchmdh.Playvid(video_url, "Test Video")
