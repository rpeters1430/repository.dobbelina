...
site_peachurnet = importlib.import_module("resources.lib.sites.peachurnet")

def test_peachurnet():
    print("Testing peachurnet...")
    site_url = "https://peachurnet.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_peachurnet.List(f"{site_url}en/")
    ...
    html = utils.getHtml(f"{site_url}en/", site_url)
    ...
    if item:
        ...
        try:
            site_peachurnet.Playvid(video_url, "Test Video")
