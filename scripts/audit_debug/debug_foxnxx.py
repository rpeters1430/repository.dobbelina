...
site_foxnxx = importlib.import_module("resources.lib.sites.foxnxx")

def test_foxnxx():
    print("Testing foxnxx...")
    site_url = "https://foxnxx.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_foxnxx.List(site_url)
    ...
    if item:
        ...
        try:
            site_foxnxx.Playvid(video_url, "Test Video")
