...
site_pornhd3x = importlib.import_module("resources.lib.sites.pornhd3x")

def test_pornhd3x():
    print("Testing pornhd3x...")
    site_url = "https://pornhd3x.tv/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_pornhd3x.List(f"{site_url}")
    ...
    item = soup.select_one(".ml-item.item")
    if item:
        ...
        try:
            site_pornhd3x.Playvid(video_url, "Test Video")
