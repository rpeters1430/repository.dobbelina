...
site_pimpbunny = importlib.import_module("resources.lib.sites.pimpbunny")

def test_pimpbunny():
    print("Testing pimpbunny...")
    site_url = "https://pimpbunny.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_pimpbunny.List(f"{site_url}videos/")
    ...
    if html:
        ...
        item = soup.select_one('[class*="card-video"]')
        if item:
            ...
            try:
                site_pimpbunny.Playvid(video_url, "Test Video")
