...
site_neporn = importlib.import_module("resources.lib.sites.neporn")

def test_neporn():
    print("Testing neporn...")
    site_url = "https://neporn.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_neporn.List(f"{site_url}latest-updates/")
    ...
    if item:
        ...
        try:
            site_neporn.Playvid(video_url, "Test Video")
