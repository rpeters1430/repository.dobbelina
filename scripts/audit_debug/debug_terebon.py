...
site_terebon = importlib.import_module("resources.lib.sites.terebon")

def test_terebon():
    print("Testing terebon...")
    site_url = "https://b.terebon.net/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_terebon.List(f"{site_url}")
