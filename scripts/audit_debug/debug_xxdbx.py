...
site_xxdbx = importlib.import_module("resources.lib.sites.xxdbx")

def test_xxdbx():
    print("Testing xxdbx...")
    site_url = "https://xxdbx.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_xxdbx.List(f"{site_url}")
    ...
    if item:
        ...
        try:
            site_xxdbx.Playvid(video_url, "Test Video")
