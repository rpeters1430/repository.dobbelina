...
site_japteenx = importlib.import_module("resources.lib.sites.japteenx")

def test_japteenx():
    print("Testing japteenx...")
    site_url = "https://www.japteenx.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_japteenx.List(f"{site_url}videos?o=mr&type=public&page=1")
    ...
    html = utils.getHtml(f"{site_url}videos?o=mr&type=public&page=1")
    soup = utils.parse_html(html)
    item = soup.select_one(".well.well-sm")
    if item:
        ...
        try:
            site_japteenx.Playvid(video_url, "Test Video")
