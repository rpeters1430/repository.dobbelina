...
site_seaporn = importlib.import_module("resources.lib.sites.seaporn")

def test_seaporn():
    print("Testing seaporn...")
    site_url = "https://www.seaporn.org/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        # SeaPorn List loops until it has 40 videos
        site_seaporn.List(f"{site_url}")
    ...
    if item:
        ...
        try:
            site_seaporn.Playvid(video_url, "Test Video")
