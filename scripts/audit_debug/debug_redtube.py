...
site_redtube = importlib.import_module("resources.lib.sites.redtube")

def test_redtube():
    print("Testing redtube...")
    site_url = "https://www.redtube.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_redtube.List(f"{site_url}")
    ...
    html = utils.getHtml(site_url, site_url, cookiehdr)
    soup = utils.parse_html(html)
    item = soup.select_one("a.video_link, a.video-title-text")
    if item:
        ...
        try:
            site_redtube.Playvid(video_url, "Test Video")
