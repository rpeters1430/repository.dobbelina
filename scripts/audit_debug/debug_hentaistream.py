...
site_hentaistream = importlib.import_module("resources.lib.sites.hentaistream")

def test_hentaistream():
    print("Testing hentaistream...")
    site_url = "https://tube.hentaistream.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_hentaistream.List(site_url)
