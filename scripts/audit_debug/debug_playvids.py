...
site_playvids = importlib.import_module("resources.lib.sites.playvids")

def test_playvids():
    print("Testing playvids...")
    site_url = "https://www.playvids.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_playvids.List(f"{site_url}?page=1")
    ...
    if item:
        ...
        try:
            site_playvids.Playvid(video_url, "Test Video")
