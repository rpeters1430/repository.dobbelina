...
site_xxthots = importlib.import_module("resources.lib.sites.xxthots")

def test_xxthots():
    print("Testing xxthots...")
    site_url = "https://xxthots.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_xxthots.List(f"{site_url}latest-updates/")
