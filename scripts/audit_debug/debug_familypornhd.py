...
site_familypornhd = importlib.import_module("resources.lib.sites.familypornhd")

def test_familypornhd():
    print("Testing familypornhd...")
    site_url = "https://familypornhd.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_familypornhd.List(site_url)
    ...
    print("\n--- Testing Categories ---")
    try:
        site_familypornhd.Categories(f"{site_url}categories/")
    ...
    if article:
        ...
        try:
            site_familypornhd.Playvid(video_url, "Test Video")
