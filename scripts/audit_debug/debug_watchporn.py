...
site_watchporn = importlib.import_module("resources.lib.sites.watchporn")

def test_watchporn():
    print("Testing watchporn...")
    site_url = "https://watchporn.to/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_watchporn.List(f"{site_url}latest-updates/")
    ...
    if item:
        ...
        try:
            site_watchporn.Playvid(video_url, "Test Video")
