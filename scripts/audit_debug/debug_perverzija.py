...
site_perverzija = importlib.import_module("resources.lib.sites.perverzija")

def test_perverzija():
    print("Testing perverzija...")
    site_url = "https://tube.perverzija.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_perverzija.List(f"{site_url}page/1/")
    ...
    item = soup.select_one("div.item-thumbnail")
    if item:
        ...
        try:
            site_perverzija.Play(video_url, "Test Video")
