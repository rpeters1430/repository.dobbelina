...
site_heavyr = importlib.import_module("resources.lib.sites.heavyr")

def test_heavyr():
    print("Testing heavyr...")
    site_url = "https://www.heavy-r.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        # Use retry logic which handles 403 by advising FlareSolverr
        # In a real Kodi it would try FlareSolverr
        site_heavyr.List(site_url)
    ...
    print("\n--- Testing Categories ---")
    try:
        site_heavyr.Categories(f"{site_url}categories/")
