...
site_fyxxr = importlib.import_module("resources.lib.sites.fyxxr")

def test_fyxxr():
    print("Testing fyxxr...")
    site_url = "https://fyxxr.to/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_fyxxr.List(f"{site_url}latest-updates/")
    ...
    if item:
        ...
        try:
            site_fyxxr.Playvid(video_url, "Test Video")
