...
site_freeomovie = importlib.import_module("resources.lib.sites.freeomovie")

def test_freeomovie():
    print("Testing freeomovie...")
    site_url = "https://www.freeomovie.to/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_freeomovie.List(site_url)
