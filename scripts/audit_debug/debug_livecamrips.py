...
site_livecamrips = importlib.import_module("resources.lib.sites.livecamrips")

def test_livecamrips():
    print("Testing livecamrips...")
    site_url = "https://www.livecamsrip.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_livecamrips.List(site_url)
    ...
    item = soup.select_one('a[href*="/watch/"]')
    if item:
        ...
        try:
            site_livecamrips.Playvid(video_url, "Test Video")
