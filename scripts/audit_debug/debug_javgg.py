...
site_javgg = importlib.import_module("resources.lib.sites.javgg")

def test_javgg():
    print("Testing javgg...")
    site_url = "https://javgg.co/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_javgg.List(f"{site_url}trending/")
    ...
    html = utils.getHtml(f"{site_url}trending/", site_url)
    ...
    if item:
        ...
        try:
            site_javgg.Playvid(video_url, "Test Video")
