...
site_porntn = importlib.import_module("resources.lib.sites.porntn")

def test_porntn():
    print("Testing porntn...")
    site_url = "https://porntn.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_porntn.List(f"{site_url}")
    ...
    if item:
        ...
        try:
            site_porntn.Playvid(video_url, "Test Video")
