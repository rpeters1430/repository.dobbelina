...
site_justporn = importlib.import_module("resources.lib.sites.justporn")

def test_justporn():
    print("Testing justporn...")
    site_url = "https://www.justporn.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_justporn.List(f"{site_url}latest-updates/")
    ...
    if item:
        ...
        try:
            site_justporn.Playvid(video_url, "Test Video")
