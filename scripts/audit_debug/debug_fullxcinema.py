...
site_fullxcinema = importlib.import_module("resources.lib.sites.fullxcinema")

def test_fullxcinema():
    print("Testing fullxcinema...")
    site_url = "https://fullxcinema.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_fullxcinema.List(f"{site_url}?filter=latest")
    ...
    if article:
        ...
        try:
            site_fullxcinema.Play(video_url, "Test Video")
