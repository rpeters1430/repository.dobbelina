...
site_paradisehill = importlib.import_module("resources.lib.sites.paradisehill")

def test_paradisehill():
    print("Testing paradisehill...")
    site_url = "https://en.paradisehill.cc/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_paradisehill.List(f"{site_url}all/?sort=created_at")
    ...
    html = utils.getHtml(f"{site_url}all/?sort=created_at")
    ...
    if item:
        ...
        try:
            site_paradisehill.Playvid(video_url, "Test Video")
