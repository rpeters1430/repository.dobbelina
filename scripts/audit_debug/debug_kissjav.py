...
site_kissjav = importlib.import_module("resources.lib.sites.kissjav")

def test_kissjav():
    print("Testing kissjav...")
    site_url = "https://kissjav.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_kissjav.List(f"{site_url}latest-updates/")
    ...
    item = soup.select_one(".thumb.item, div.thumb")
    if item:
        ...
        try:
            site_kissjav.Playvid(video_url, "Test Video")
