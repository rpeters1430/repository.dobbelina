...
site_pornez = importlib.import_module("resources.lib.sites.pornez")

def test_pornez():
    print("Testing pornez...")
    site_url = "https://pornezoo.net/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_pornez.List(site_url)
    ...
    html, _ = utils.get_html_with_cloudflare_retry(site_url)
    if html:
        ...
        if item:
            ...
            try:
                site_pornez.Play(video_url, "Test Video")
