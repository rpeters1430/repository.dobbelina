...
site_justfullporn = importlib.import_module("resources.lib.sites.justfullporn")

def test_justfullporn():
    print("Testing justfullporn...")
    site_url = "https://justfullporn.net/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_justfullporn.List(site_url)
    ...
    if item:
        ...
        try:
            site_justfullporn.Playvid(video_url, "Test Video")
