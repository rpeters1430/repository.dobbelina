...
site_javguru = importlib.import_module("resources.lib.sites.javguru")

def test_javguru():
    print("Testing javguru...")
    site_url = "https://jav.guru/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_javguru.List(site_url)
