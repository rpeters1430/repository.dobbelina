...
site_yourlesbians = importlib.import_module("resources.lib.sites.yourlesbians")

def test_yourlesbians():
    print("Testing yourlesbians...")
    site_url = "https://yourlesbians.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_yourlesbians.List(site_url)
