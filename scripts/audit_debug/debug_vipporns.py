...
site_vipporns = importlib.import_module("resources.lib.sites.vipporns")

def test_vipporns():
    print("Testing vipporns...")
    site_url = "https://www.vipporns.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_vipporns.List(f"{site_url}new-porn-video/")
    ...
    html = utils.getHtml(f"{site_url}new-porn-video/", site_url)
    ...
    if item:
        ...
        try:
            site_vipporns.Playvid(video_url, "Test Video")
