...
site_trannyteca = importlib.import_module("resources.lib.sites.trannyteca")

def test_trannyteca():
    print("Testing trannyteca...")
    site_url = "https://www.trannyteca.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_trannyteca.List(f"{site_url}")
    ...
    if item:
        ...
        try:
            site_trannyteca.Playvid(video_url, "Test Video")
