...
site_thepornarea = importlib.import_module("resources.lib.sites.thepornarea")

def test_thepornarea():
    print("Testing thepornarea...")
    site_url = "https://thepornarea.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_thepornarea.List(f"{site_url}latest-updates/")
    ...
    if item:
        ...
        try:
            site_thepornarea.Playvid(video_url, "Test Video")
