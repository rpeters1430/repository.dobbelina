...
site_porngo = importlib.import_module("resources.lib.sites.porngo")

def test_porngo():
    print("Testing porngo...")
    site_url = "https://www.porngo.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_porngo.List(f"{site_url}latest-updates/")
    ...
    item = soup.select_one("div.thumb.item")
    if item:
        link = item.select_one("a.thumb__top")
        ...
        try:
            site_porngo.Play(video_url, "Test Video")
