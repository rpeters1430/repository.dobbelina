...
site_yrprno = importlib.import_module("resources.lib.sites.yrprno")

def test_yrprno():
    print("Testing yrprno...")
    site_url = "https://www.yrprno.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_yrprno.List(f"{site_url}most-recent/")
