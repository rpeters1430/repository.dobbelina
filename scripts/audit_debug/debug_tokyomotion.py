...
site_tokyomotion = importlib.import_module("resources.lib.sites.tokyomotion")

def test_tokyomotion():
    print("Testing tokyomotion...")
    site_url = "https://www.tokyomotion.net/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_tokyomotion.List(f"{site_url}videos?type=public&o=mr&page=1")
    ...
    video_url = "https://www.tokyomotion.net/video/6452538/海外コスプレ③"
    print(f"Testing playback for: {video_url}")
    try:
        site_tokyomotion.Playvid(video_url, "Test Video")
