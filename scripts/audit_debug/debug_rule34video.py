...
site_rule34video = importlib.import_module("resources.lib.sites.rule34video")

def test_rule34video():
    print("Testing rule34video...")
    site_url = "https://rule34video.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_rule34video.List(f"{site_url}latest-updates/")
    ...
    if item:
        ...
        try:
            site_rule34video.Playvid(video_url, "Test Video")
