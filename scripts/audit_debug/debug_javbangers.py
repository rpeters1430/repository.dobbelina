...
site_javbangers = importlib.import_module("resources.lib.sites.javbangers")

def test_javbangers():
    print("Testing javbangers...")
    site_url = "https://javbangers.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_javbangers.List(f"{site_url}latest-updates/")
