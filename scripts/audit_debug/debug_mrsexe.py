...
site_mrsexe = importlib.import_module("resources.lib.sites.mrsexe")

def test_mrsexe():
    print("Testing mrsexe...")
    site_url = "https://www.mrsexe.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_mrsexe.List(site_url)
    ...
    item = soup.select_one("ul.thumb-list li")
    if item:
        ...
        try:
            site_mrsexe.Playvid(video_url, "Test Video")
