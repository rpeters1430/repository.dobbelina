...
site_homemoviestube = importlib.import_module("resources.lib.sites.homemoviestube")

def test_homemoviestube():
    print("Testing homemoviestube...")
    site_url = "https://www.homemoviestube.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_homemoviestube.List(f"{site_url}most-recent/")
    ...
    print("\n--- Testing Categories ---")
    try:
        site_homemoviestube.Categories(f"{site_url}channels/")
    ...
    html = utils.getHtml(f"{site_url}most-recent/")
    soup = utils.parse_html(html)
    item = soup.select_one(".vidItem, .video, .video-item")
    if item:
        ...
        try:
            site_homemoviestube.Playvid(video_url, "Test Video")
