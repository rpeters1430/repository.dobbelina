...
site_playhdporn = importlib.import_module("resources.lib.sites.playhdporn")

def test_playhdporn():
    print("Testing playhdporn...")
    site_url = "https://playhdporn.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_playhdporn.List(f"{site_url}")
    ...
    if item:
        ...
        try:
            site_playhdporn.Playvid(video_url, "Test Video")
