...
site_xsharings = importlib.import_module("resources.lib.sites.xsharings")

def test_xsharings():
    print("Testing xsharings...")
    site_url = "https://xsharings.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_xsharings.List(f"{site_url}page/1?filter=latest")
    ...
    if item:
        ...
        try:
            site_xsharings.Play(video_url, "Test Video")
