...
site_youcrazyx = importlib.import_module("resources.lib.sites.youcrazyx")

def test_youcrazyx():
    print("Testing youcrazyx...")
    site_url = "https://www.youcrazyx.com/"
    
    # Test Listing
    print("\n--- Testing Listing ---")
    try:
        site_youcrazyx.List(site_url)
    ...
    item = soup.select_one("a.video-link")
    if item:
        ...
        try:
            site_youcrazyx.Playvid(video_url, "Test Video")
