...
def INDEX():
    utils.addDir(
        ...
        "",
        120,
        os.path.join(rootDir, "help.png"),
        "",
    )
    utils.addDir(
        "[COLOR hotpink]Whitecream[/COLOR] [COLOR white]Scenes[/COLOR]",
        "",
        1,
    ...
    utils.addDir(
        "[COLOR hotpink]Whitecream[/COLOR] [COLOR white]Movies[/COLOR]",
        "",
        2,
        os.path.join(rootDir, "icon.png"),
        "",
    ...
    utils.addDir(
        "[COLOR hotpink]Whitecream[/COLOR] [COLOR white]Hentai[/COLOR]",
        "",
        3,
        os.path.join(rootDir, "icon.png"),
        "",
    ...
    utils.addDir(
        "[COLOR hotpink]Whitecream[/COLOR] [COLOR white]Tubes[/COLOR]",
        "",
        6,
        os.path.join(rootDir, "icon.png"),
        "",
...
def INDEXS():
    ...
    utils.addDir(
        ...
        "http://beeg.com/page-1",
        80,
        os.path.join(imgDir, "bg.png"),
        "",
    )
    utils.addDir(
        "[COLOR hotpink]XvideoSpanish[/COLOR]",
        "http://www.xvideospanish.net/",
        130,
    ...
    utils.addDir(
        ...
        "http://www.viralvideosporno.com/",
        760,
        "http://www.viralvideosporno.com/plantilla/imagenes/logo.jpg",
        "",
    )
    utils.addDir(
        "[COLOR hotpink]StreamXXX[/COLOR]",
        "http://streamxxx.tv/category/clips/",
        170,
    ...
    utils.addDir(
        ...
        340,
        os.path.join(imgDir, "hdzog.png"),
        "",
    )
    utils.addDir(
        "[COLOR hotpink]Mr Sexe[/COLOR]",
        "http://www.mrsexe.com/",
        400,
        os.path.join(imgDir, "mrsexe.png"),
        "",
    )
    utils.addDir(
        "[COLOR hotpink]XXX Streams (eu)[/COLOR]",
        "http://xxxstreams.eu/",
        410,
    ...
    utils.addDir(
        "[COLOR hotpink]XXX Streams (org)[/COLOR]",
        "http://xxxstreams.org/",
        420,
    ...
    utils.addDir(
        "[COLOR hotpink]sxyprn(YourPorn)[/COLOR]",
        "https://sxyprn.com/",
        650,
    ...
    utils.addDir(
        ...
        "https://www.javbangers.com/latest-updates/1/",
        55,
        "https://www.javbangers.com/images/logo.png",
        "",
    )
    utils.addDir(
        "[COLOR hotpink]DatoPorn[/COLOR]",
        "http://datoporn.co/",
        670,
    ...
    utils.addDir(
        "[COLOR hotpink]Pornvibe[/COLOR]",
        "https://pornvibe.org/",
        680,
        os.path.join(imgDir, "pornvibe.png"),
        "",
    )
    utils.addDir(
        "[COLOR hotpink]PornGo(YesPornPlease)[/COLOR]",
        "https://www.porngo.com/latest-updates/1/",
        690,
    ...
    utils.addDir(
        ...
        720,
        os.path.join(imgDir, "porndoe.png"),
        "",
    )
    utils.addDir(
        "[COLOR hotpink]ClipHunter[/COLOR]",
    ...
    utils.addDir(
        "[COLOR hotpink]FreePornStreams[/COLOR]",
        "http://freepornstreams.org/",
        740,
    ...
    utils.addDir(
        ...
        770,
        os.path.join(imgDir, "xozilla.png"),
        "",
    )
    utils.addDir(
        "[COLOR hotpink]Eporner[/COLOR]",
        "https://www.eporner.com/category/all/",
        540,
        "https://static-eu-cdn.eporner.com/new/logo.png",
        "",
    )
    utils.addDir(
        "[COLOR hotpink]HereXXX[/COLOR]",
        "https://herexxx.com/",
        530,
    ...
    utils.addDir(
        "[COLOR hotpink]Hotpornfile[/COLOR]",
    ...
    utils.addDir(
        "[COLOR hotpink]IPornoVideos[/COLOR]", "http://ipornovideos.com/", 260, "", ""
    )
    utils.addDir(
        "[COLOR hotpink]Cambro[/COLOR]",
        "https://www.cambro.tv/",
        110,
        os.path.join(imgDir, "cambro.png"),
        "",
    )
    utils.addDir(
        "[COLOR hotpink]Reallifecam[/COLOR]",
        "https://www.reallifecam.to/",
        230,
        "https://reallifecam.to/images/logo/logo.png",
        0,
    )
    utils.addDir(
        "[COLOR hotpink]Voyeur-house[/COLOR]",
        "https://voyeur-house.to",
        230,
        "https://voyeur-house.to/images/logo/logo.png",
        1,
    )
    utils.addDir(
        "[COLOR hotpink]JAVhoho[/COLOR]",
        "https://javhoho.com/",
        310,
    ...
    utils.addDir(
        "[COLOR hotpink]FreeVideo[/COLOR]",
        "https://freevideo.cz",
        960,
        os.path.join(imgDir, "freevideo.png"),
        "",
    )
    utils.addDir(
        "[COLOR hotpink]BitPorno[/COLOR]",
        "https://www.bitporno.com/search/all/sort-mostviewed/time-today/page-0",
        860,
        "https://www.bitporno.com/images/logobt.png",
        "",
    )
    utils.addDir(
        "[COLOR hotpink]PornHD[/COLOR]",
        "https://www.pornhd.com/",
        870,
        os.path.join(imgDir, "PornHD.jpg"),
        "",
    )
    utils.addDir(
        "[COLOR hotpink]PeekVids[/COLOR]",
        "https://www.peekvids.com/",
        890,
        os.path.join(imgDir, "peekvids.png"),
        "",
    )
...
def INDEXM():
    ...
    utils.addDir(
        "[COLOR hotpink]JustPorn[/COLOR]",
        "http://justporn.to/category/dvdrips-full-movies/",
        240,
    ...
    utils.addDir(
        "[COLOR hotpink]StreamXXX[/COLOR]",
        "http://streamxxx.tv/category/movies/",
        175,
        os.path.join(imgDir, "streamxxx.png"),
        "",
    )
    utils.addDir(
        "[COLOR hotpink]Paradise Hill[/COLOR]",
        "http://www.paradisehill.tv/en/",
        250,
    ...
    utils.addDir(
        ...
        370,
        os.path.join(imgDir, "freeomovies.png"),
        "",
    )
    utils.addDir(
        ...
        "https://speedporn.net/",
        780,
        os.path.join(imgDir, "speedporn11.png"),
        "",
    )
    utils.addDir(
        "[COLOR hotpink]PandaMovie[/COLOR]",
        "https://pandamovies.pw/adult/movies/page/1/",
        600,
        os.path.join(imgDir, "pandamovie.png"),
        "",
    )
    utils.addDir(
        ...
        810,
        os.path.join(imgDir, "netflixporno-1.png"),
        "",
    )
    ...
    utils.addDir(
        ...
        "https://mangoporn.net/",
        800,
        os.path.join(imgDir, "mangoporn.png"),
        "",
    )
    xbmcplugin.endOfDirectory(utils.addon_handle, cacheToDisc=False)
...
def INDEXT():
    utils.addDir(
        "[COLOR hotpink]BubbaPorn[/COLOR]",
        "http://www.bubbaporn.com/page1.html",
        90,
    ...
    utils.addDir(
        ...
        "http://www.poldertube.nl/",
        100,
        os.path.join(imgDir, "poldertube.png"),
        0,
    )
    utils.addDir(
        "[COLOR hotpink]12Milf.nl[/COLOR] [COLOR orange](Dutch)[/COLOR]",
        "https://www.12milf.com/",
        100,
        os.path.join(imgDir, "12milf.png"),
        1,
    )
    utils.addDir(
        ...
        100,
        os.path.join(imgDir, "sextube.png"),
        2,
    )
    utils.addDir(
        "[COLOR hotpink]Txxx[/COLOR]",
        "http://txxx.com",
        380,
        "https://txxx.com/static/images/favicons/apple-touch-icon.png",
        "",
    )
    utils.addDir(
    ...
    utils.addDir(
        ...
        "http://voyeurhit.com",
        380,
        "https://voyeurhit.com/static/images/logo.png",
        "",
    )
    utils.addDir(
    ...
    utils.addDir(
        ...
        "https://www.pornhub.com/newest.html",
        390,
    ...
    utils.addDir(
        ...
        290,
        os.path.join(imgDir, "porndig.png"),
        "",
    )
    utils.addDir(
    ...
    utils.addDir(
        ...
        "http://anybunny.com/",
        320,
        os.path.join(imgDir, "anybunny.png"),
        "",
    )
    utils.addDir(
        "[COLOR hotpink]SpankBang[/COLOR]",
        "http://spankbang.com/new_videos/",
        440,
        os.path.join(imgDir, "spankbang.png"),
        "",
    )
    utils.addDir(
        "[COLOR hotpink]Amateur Cool[/COLOR]",
        "http://www.amateurcool.com/most-recent/",
        490,
        os.path.join(imgDir, "amateurcool.png"),
        "",
    )
    utils.addDir(
        "[COLOR hotpink]PornOne[/COLOR]",
        "https://pornone.com/newest/",
        500,
        os.path.join(imgDir, "porn1.png"),
        "",
    )
    utils.addDir(
        ...
        "https://xhamster.com/",
        505,
        os.path.join(imgDir, "xhamster.png"),
        "",
    )
    utils.addDir(
    ...
    utils.addDir(
        "[COLOR hotpink]redTube[/COLOR]",
        "https://api.redtube.com/?data=redtube.Videos.searchVideos&output=json&page=1&ordering=newest",
        590,
        os.path.join(imgDir, "RedTube.jpg"),
        "",
    )
    utils.addDir(
        "[COLOR hotpink]Desixnxx[/COLOR]",
        "http://desixnxx2.net/last-added/",
        850,
        os.path.join(imgDir, "desixnxx.png"),
        "",
    )
    utils.addDir(
        "[COLOR hotpink]Masalaseen[/COLOR]",
        "https://masalaseen.com/page/1/",
        855,
        os.path.join(imgDir, "masalaseen.png"),
        "",
    )
...
def INDEXW():
    ...
    utils.addDir(
        "[COLOR hotpink]Cam4[/COLOR] [COLOR white]- webcams[/COLOR]",
        "http://www.cam4.com",
        280,
        os.path.join(imgDir, "cam4.png"),
        "",
    )
    utils.addDir(
        ...
        475,
        os.path.join(imgDir, "camsoda.png"),
        "",
    )
    utils.addDir(
    ...
    utils.addDir(
        ...
        520,
        os.path.join(imgDir, "bongacams.png"),
        "",
    )
    utils.addDir(
        "[COLOR hotpink]RedTube Live[/COLOR] [COLOR white]- webcams[/COLOR]",
        "https://www.redtube.com/live?track=6001",
        580,
        os.path.join(imgDir, "RedTube.jpg"),
        "",
    )
...
def INDEXH():
    utils.addDir(
        ...
        "http://hentaihaven.org/?sort=date",
        460,
        os.path.join(imgDir, "hh.png"),
        "",
    )
    utils.addDir(
        "[COLOR hotpink]Animeid Hentai[/COLOR]",
        "https://animeidhentai.com/hentai",
        660,
        os.path.join(imgDir, "ah.png"),
        "",
    )
    utils.addDir(
        "[COLOR hotpink]CartoonPornVideos[/COLOR]",
        "https://www.cartoonpornvideos.com/videos/straight/all-recent-1.html",
        930,
        os.path.join(imgDir, "cartoonpornvideos.png"),
        "",
    )
    utils.addDir(
        "[COLOR hotpink]Hentaidude[/COLOR]",
        "https://hentaidude.com/page/1/",
        920,
        os.path.join(imgDir, "hentaidude.png"),
        "",
    )
    xbmcplugin.endOfDirectory(utils.addon_handle, cacheToDisc=False)
...
def ONELIST(page=1):
    ...
    npage = page + 1
    utils.addDir(
        "[COLOR hotpink]Next page (" + str(npage) + ")[/COLOR]", "", 5, "", npage
    )
...
def change():
    ...
    if addon.getSetting("changelog_seen_version") == version or not os.path.isfile(
        utils.changelog
    ):
        return
...
if not addon.getSetting("uwcage") == "true":
    age = dialog.yesno(
        "WARNING: This addon contains adult material.",
        "You may enter only if you are at least 18 years of age.",
        nolabel="Exit",
        yeslabel="Enter",
    )
    if age:
