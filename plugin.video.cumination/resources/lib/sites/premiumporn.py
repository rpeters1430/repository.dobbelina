            ...
            if "vidara" in embed_url:
                ...
                if is_bysewihe_host or is_g9r6_host:
                    ...
                    hdr = {
                        ...
                        "x-embed-parent": "https://bysewihe.com/e/{}/backroom-casting-couch-its-straight-to-the-ass-for-this-hesitant-thespian-anna-starr-premiumporn-org".format(video_id),
