...
site = AdultSite('tube8', '[COLOR hotpink]Tube8[/COLOR]', 'https://www.tube8.com/', 'tube8.png', 'tube8')
...
def List(url):
    ...
    if current_page:
        ...
        try:
            ...
            next_page = soup.select_one(f'.pagination_pages_list a[href*="page/{next_num}"]')
            if next_page:
