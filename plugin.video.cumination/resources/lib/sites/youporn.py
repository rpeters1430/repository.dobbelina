...
site = AdultSite('youporn', '[COLOR hotpink]YouPorn[/COLOR]', 'https://www.youporn.com/', 'youporn.png', 'youporn')
...
def List(url):
    ...
    next_page = soup.select_one('.pagination_pages_list a.tm_pagination_link:last-of-type')
    if next_page:
